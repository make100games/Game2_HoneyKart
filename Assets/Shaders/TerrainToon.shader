Shader "Universal Render Pipeline/Terrain/Toon"
{
    Properties
    {
        _FresnelColor("Fresnel Color", Color) = (0,1,0,0)
        _FresnelPower("Fresnel Power", Range(1,8)) = 2
        _FresnelStrength("Fresnel Strength", Range(0,2)) = 2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "TerrainToonPasses.hlsl"
            ENDHLSL
        }
